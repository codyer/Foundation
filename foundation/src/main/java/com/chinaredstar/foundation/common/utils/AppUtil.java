...
public class AppUtil {
    ...
    public static String getDeviceId() {
        String deviceId = ((TelephonyManager) FoundationApplication.getContext().getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();
    ...
    private boolean isAppOnForeground() {
        ActivityManager activityManager = (ActivityManager) FoundationApplication.getContext().getSystemService(Context.ACTIVITY_SERVICE);
