...
/**
 * Created by Zhou Yang on 2016/7/13.
 */
public class Constant {
    public final static String PKG_NAME = BaseApplication.getContext().getPackageName();
    ...
    public interface HttpUrl {
        ...
        String BASE_URL = "api.uc.redstar.dev";//开发环境
//        String BASE_URL = "api.uc.hxmklmall.cn";//测试环境
//        String BASE_URL = "api.uc.redstar.pro";//正式环境
