package com.redstar.foundation.utils.http;
...
import com.redstar.foundation.utils.ImageUtil;
...
public class HttpManager {
    private static HttpManager sHttpManager = null;
    ...
    public static synchronized HttpManager getInstance() {
        if (sHttpManager == null) {
            sHttpManager = new HttpManager(BaseApplication.getContext());
        }
        return sHttpManager;
    }
